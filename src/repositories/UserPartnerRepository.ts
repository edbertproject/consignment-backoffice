...
const Repository = {
    all: function (params: any = null) {
        return api.get(`${endPoint()}/api/admin/user-partner`, {
            params,
    ...
    show: function (id: number | string, params: any = null) {
        return api.get(`${endPoint()}/api/admin/user-partner/${id}`, {
            params,
    ...
    create: function (payload: any, params: any = null) {
        return api.post(`${endPoint()}/api/admin/user-partner`, payload, {
            params,
    ...
    update: function (id: number | string, payload: any, params: any = null) {
        return api.post(`${endPoint()}/api/admin/user-partner/${id}`, payload, {
            params,
    ...
    delete: function (id: number | string, params: any = null) {
        return api.delete(`${endPoint()}/api/admin/user-partner/${id}`, {
            params,
    ...
    updateStatus: function (id: number | string, payload: any, params: any = null) {
        return api.put(`${endPoint()}/api/admin/user-partner/status/${id}`, payload, {
            params,
