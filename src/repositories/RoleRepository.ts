...
const Repository = {
    all: function (params: any = null) {
        return api.get(`${endPoint()}/api/admin/roles`, {
            params,
    ...
    show: function (id: number | string, params: any = null) {
        return api.get(`${endPoint()}/api/admin/role/${id}`, {
            params,
    ...
    create: function (payload: any, params: any = null) {
        return api.post(`${endPoint()}/api/admin/role`, payload, {
            params,
    ...
    update: function (id: number | string, payload: any, params: any = null) {
        return api.put(`${endPoint()}/api/admin/role/${id}`, payload, {
            params,
    ...
    delete: function (id: number | string, params: any = null) {
        return api.delete(`${endPoint()}/api/admin/role/${id}`, {
            params,
            cancelToken: cancelTokenHandlerObject[this.delete.name].handleRequestCancellation().token
        });
    },
    permissionOptions: function (params: any = null) {
        return api.get(`${endPoint()}/api/admin/select/permissions`, {
            params,
            cancelToken: cancelTokenHandlerObject[this.permissionOptions.name].handleRequestCancellation().token
        });
    },
